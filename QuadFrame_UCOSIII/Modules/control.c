/**
  ...
  * @version V1.1
  * @date    2016-8-11
  * @brief   This file contains the inner control loop of quadrotor
  ******************************************************************************
  * @attention
  *             None
  ******************************************************************************
...
/*
*********************************************************************************************************
*                                    FUNCTION ABOUT INNER CONTROLER
*********************************************************************************************************
*/
/**
* @brief  get the target angular velocity
* @param  const EULER euler_target
          const EULER euler
*         VECTOR *target_rate : output target angular velocity
* @retval None
*/
void CTRL_GetTargetRate(const EULER euler_target, const EULER euler, VECTOR *target_rate)
{
  ...
  rate.x =  error_tmp.x                           - error_tmp.z * arm_sin_f32(euler.pitch);
...
*/
/**
* @brief  Control angular velocity
* @param  VECTOR target_rate 
*         const VECTOR gyro_rate
*         CTRL_DataType *control_data : output
*         sys_params_t sys_params : quadrotor paraments
*         const float dt : time interval
*         uint8_t en_flag : flag
* @retval None
*/
