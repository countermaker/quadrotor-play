/**
  ...
  * @version V1.1
  * @date    2016-8-8
  * @brief   This file contains all the algorithm of the conversion of coordinates for the 
  *          robotics and the math operation for robotics
  ******************************************************************************
  * @attention
  *             None
  ******************************************************************************
...
/*
*********************************************************************************************************
*                                    FUNCTION ABOUT COORDINATE CONVERT 
*********************************************************************************************************
*/

/**
* @brief  (small angle rotate) convert reference coordinate to body coordinate
* @param  VECTOR *vect: the vector in reference coordinate
          EULER *ypr  : the Euler angle (ZYX rotate sequence) 
* @retval None
*/
...
/**
* @brief  Convert body coordinate to reference coordinate
* @param  VECTOR *to:   the vector in reference coordinate
*         VECTOR *from: the vector in body coordinate
          EULER *e  : the Euler angle (ZYX rotate sequence) 
* @retval None
*/
...
/**
* @brief  convert body coordinate to reference coordinate(XY plane)
* @param  VECTOR *to:   the vector in reference coordinate
*         VECTOR *from: the vector in body coordinate
          EULER *e  : the Euler angle (ZYX rotate sequence) 
* @retval None
...
void EulerRoateVectXY(VECTOR *to, VECTOR *from, EULER *e)
{
  ...
  to->y = tmp.x * 0.0f         + tmp.y * (cos_roll)             + tmp.z * (-sin_roll);
  to->z = tmp.x * (-sin_pitch) + tmp.y * (cos_pitch * sin_roll) + tmp.z * (cos_pitch * cos_roll);
}
/**
* @brief  normalize quaternion
* @param  QUATERNION *q : the quaternion you want to normalize
* @retval None
*/
...
/**
* @brief  conjunction of a quaternion
* @param  QUATERNION q        : the quaternion you want to conjugate
...
/**
* @brief  copy a quadternion from a to b
* @param  QUATERNION a : the quaternion you want to copy
*         QUATERNION *b: the result
* @retval None
*/
...
* @param  VECTOR *v : the vector you want normalize
* @retval norm_inv
*/
...
/**
* @brief  result = q_left x q_right
* @param  QUATERNION *result , const QUATERNION q_left , const QUATERNION q_right
* @retval none
*/
...
/**
* @brief  using quaternion rotate a vector b(quadcopter coordinate)->R(Referent Coordinate) a->b
* @param  const QUATERNION *rotation , VECTOR *a, VECTOR *b
* @retval none
*/
...
/**
* @brief  using quaternion rotate a vector R(Referent Coordinate)->b(quadcopter coordinate) a->b
* @param  const QUATERNION *rotation , VECTOR *a, VECTOR *b
* @retval none
*/
...
/**
* @brief  compute cross(a,b)
* @param  VECTOR *result , const VECTOR a, const VECTOR b
* @retval none
*/
...
/**
* @brief  compute sum of two vector
* @param  VECTOR *result , const VECTOR a, const VECTOR b
* @retval none
*/
...
/**
* @brief  compute substruct of two vector (a - b)
* @param  VECTOR *result , const VECTOR a, const VECTOR b
* @retval none
*/
...
/**
* @brief  get quaternion from two vectors whitch have been rotated
* @param  QUATERNION *q , const VECTOR from, const VECTOR to
* @retval none
*/
...
/**
* @brief  convert a quaternion to vector 
* @param  VECTOR *v,QUATERNION *q
* @retval none
*/
...
/*
*********************************************************************************************************
*                                    FUNCTION ABOUT BASIC MATH OPERATION
*********************************************************************************************************
*/
/**
* @brief  constraint a's value (lower <= a <= upper)
* @param  float a , float lower , float upper
* @retval none
*/
...
/**
* @brief  constraint a's value(int) (lower <= a <= upper)
* @param  float a , float lower , float upper
* @retval none
*/
...
* @param  float new_data, float old_data, float a, float dt
* @retval float
*/
