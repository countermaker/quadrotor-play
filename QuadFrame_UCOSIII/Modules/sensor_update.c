...
const float AccMax_X =   10.094972;
const float AccMin_X =  -9.561400;

const float AccMax_Y = 9.888026;
const float AccMin_Y =  -9.676942;

const float AccMax_Z =  10.977931;
const float AccMin_Z =  -9.071832;
