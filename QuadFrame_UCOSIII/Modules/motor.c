...
*/
/**
* @brief  convert the moment to pwm width
* @param  CTRL_DataType *control_data
					MOTOR_DataType *motor
          const sys_params_t sys_params
* @retval None
*/
...
/**
* @brief  motor min trust
* @param  MOTOR_DataType *motor
* @retval None
*/
...
/**
* @brief  compensate the motor mechanics effect
* @param  MOTOR_DataType *motor
* @retval None
*/
